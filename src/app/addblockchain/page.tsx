...
const UploadForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post(`${apiUrl}/api/blockchain/add`, formData, {
        headers: {
  ...
  return (
    <>
        <div className="max-w-md mx-auto bg-white p-8 mt-24 border border-gray-300 rounded-lg shadow-md">
            <h2 className="text-2xl font-semibold mb-6 text-center">Add Blockchain</h2>
        ...
        <div className="max-w-md mx-auto bg-white p-8 mt-24 border border-gray-300 rounded-lg shadow-md">
            <h2 className="text-2xl font-semibold mb-6 text-center">Update Blockchain</h2>
            <form onSubmit={handleSubmit}>
                <div className="mb-4">
                <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="name">
                    Name:
